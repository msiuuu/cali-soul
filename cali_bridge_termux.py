"""
cali's bridge — termux edition. runs on mish's phone.
gives remote-cali access to android shell + files.
same auth, same endpoints, sh instead of powershell.
"""
...
if __name__ == "__main__":
    ...
    print(f"\n  cali bridge — termux edition")
    print(f"  port: {PORT}")
    print(f"  token: {TOKEN}")
    print(f"  token source: {TOKEN_SOURCE}")
    print(f"  token saved: {token_file}")
    print(f"\n  run cloudflared next:")
    print(f"  cloudflared tunnel --url http://localhost:{PORT}")
    print(f"\n  paste the tunnel URL to cali. she'll take it from there.\n")
